...
export class CallsService {
    ...
    loadCall(): Observable<any> {
        return this.httpClient.get(this.config.BaseURL + 'callsreg');
    }
    ...
    loadDatamatch(commodityname: string): Observable<any> {
        ...
        return this.httpClient.post(this.config.BaseURL + 'buymatchUR', { COMM: commodityname });
    }
    loadDatamatchR(ID: string): Observable<any> {
        console.log(ID);
        return this.httpClient.post(this.config.BaseURL + 'Rtmatch', { request: ID });
    }
}
